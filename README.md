...
[libusb](http://libusb.org)-based user-mode driver for [MCP2200](http://www.microchip.com/wwwproducts/Devices.aspx?dDocName=en546923)

What?
=====

This project aims to provide an easy-to-use and simple install-less HID driver for [MCP2200](http://www.microchip.com/wwwproducts/Devices.aspx?dDocName=en546923) an USB-to-UART serial converter produced by Microchip . Basically, it is a cross-platform C library using [libusbx](http://libusbx.org), providing simple API which can access the functions of the device. 
...
> Note #1: mcp2200 is using libusb, which is licensed under LGPL 2.1 (http://www.gnu.org/licenses/lgpl-2.1.html).
